...
import { ITeacherResponse } from 'src/app/core/interfaces/signup.interface';
...
export class UserListComponent implements OnInit {
  ...
  ngOnInit() {
    this.jwtService.getParam().subscribe((param: string) => {
  ...
  loadUsers(param: string): void {
    this.teacherService.getAllUsers(param).subscribe(
      (data: User[]) => {
        this.users = data;
        console.log(data);
